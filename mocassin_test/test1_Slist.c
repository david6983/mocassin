...
#include "test1_structures.h"
#include "test1_Slist.h"
...
SListEngine initSlistEngine(void)
{
    ...
    SLIST_ENGINE_GENERATE_DISPLAY_NODE_METHODS(e, real_number)
    ...
    SLIST_ENGINE_GENERATE_COMPARE_NODE_METHODS(e, real_number)
...
GENERATE_DISPLAY_NODE_METHOD_SIMPLE_TYPE(real_number, "\t\t[VALUE] %f \n")
...
GENERATE_COMPARE_SIMPLE_TYPE_METHOD(real_number)
