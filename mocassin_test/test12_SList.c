...
SListEngine initSlistEngine(void)
{
    ...
    /* AUTO GENERATED CODE */
    SLIST_ENGINE_GENERATE_DISPLAY_NODE_METHODS(e, rectangle)
    ...
    SLIST_ENGINE_GENERATE_COMPARE_NODE_METHODS(e, rectangle)
...
GENERATE_DISPLAY_NODE_METHOD_USER_STRUCT(rectangle)
...
GENERATE_COMPARE_USER_STRUCTURE_COMPARE_METHOD_CALLBACK(rectangle)
