...
void displayNode_system(SList head);
void displayNode_direction(SList head);

char* direction_toString_callback(direction e);

/* callbacks for searching */
void searchNode_system(SList head, SList *searched, system system);
...
SListCompare_type compare_system(SListSingleData data1, SListSingleData data2);
SListCompare_type compare_direction(SListSingleData data1, SListSingleData data2);
