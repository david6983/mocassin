...
SListEngine initSlistEngine(void)
{
    ...
    /* AUTO GENERATED CODE */
    SLIST_ENGINE_GENERATE_DISPLAY_NODE_METHODS(e, system)
    SLIST_ENGINE_GENERATE_DISPLAY_NODE_METHODS(e, direction)
    ...
    SLIST_ENGINE_GENERATE_COMPARE_NODE_METHODS(e, system)
    SLIST_ENGINE_GENERATE_COMPARE_NODE_METHODS(e, direction)
...
char* direction_toString_callback(direction e){
    switch(e) {
        case north:
            return "north";
        case east:
...
GENERATE_DISPLAY_NODE_METHOD_ENUM(direction)

/* display struct */

GENERATE_DISPLAY_NODE_METHOD_USER_STRUCT(system)
...
GENERATE_COMPARE_SIMPLE_TYPE_METHOD(direction)

GENERATE_COMPARE_USER_STRUCTURE_COMPARE_METHOD_CALLBACK(system)
