...
#include "test5_structures.h"
#include "test5_Slist.h"
...
char* pos_toString_callback(pos e){
    switch(e) {
        case nw:
            return "nw";
        case sw:
...
GENERATE_DISPLAY_NODE_METHOD_ENUM(pos)
...
GENERATE_COMPARE_SIMPLE_TYPE_METHOD(pos)
