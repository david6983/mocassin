...
/* GENERATE */
#define NB_DATA_TYPE 6 //except none
/* GENERATE_END */
...
void displayNode_long_number(SList head);
void displayNode_real_number(SList head);
...
void searchNode_long_number(SList head, SList *searched, long int long_number);
void searchNode_real_number(SList head, SList *searched, float real_number);
...
SListCompare_type compare_long_number(SListSingleData data1, SListSingleData data2);
SListCompare_type compare_real_number(SListSingleData data1, SListSingleData data2);
