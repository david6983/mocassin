...
/* GENERATE */
#define NB_DATA_TYPE 3 //except none
/* GENERATE_END */
...
void displayNode_pos(SList head);

char* pos_toString_callback(pos e);

/* callbacks for searching */
void searchNode_pos(SList head, SList *searched, pos pos);
...
SListCompare_type compare_pos(SListSingleData data1, SListSingleData data2);
