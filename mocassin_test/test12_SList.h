...
void displayNode_rectangle(SList head);
void displayNode_position(SList head);

char* position_toString_callback(position e);

/* callbacks for searching */
void searchNode_rectangle(SList head, SList *searched, rectangle rectangle);
...
SListCompare_type compare_rectangle(SListSingleData data1, SListSingleData data2);
